	...
	<div class="container">
	    <div class="row">
	        <div class="col-md-4">
	            ...
	            <address>
	                <strong>ElArabeyia.com</strong><br>
	                Attia el sawalhy st, Mall one<br>
	                El Serag mall, NasrCity, Cairo<br>
	                <abbr title="Mobile Phone">
	                    Mob :</abbr>
	                (02) 01100466647
	            </address>
	            <address>
	                Email: <a href="haroun_hn@hotmail.com"> Haroun_hn@hotmail.com</a>
	            </address>
	            </form>
	        </div>
	    </div>
